...
4 & 0.68 & 24 & 217.28 & Liquid + vapour (chamber; $h_4 = h_3 - w_{\mathrm{out}}$) \\
\bottomrule
\end{tabular}
\end{table}
State 4 is two-phase; $h_4$ lies between $h_{\mathrm{f,L}}$ and
$h_{\mathrm{f,L}}+h_{\mathrm{fg}}$ and is fixed by the first law in process 3$\to$4 (adiabatic expander): $h_4 = h_3 - w_{\mathrm{out}} \approx 217.28\,\mathrm{kJ}/\mathrm{kg}$ (process 3$\to$4 above). The balance
...
$h_4 = h_3 - w_{\mathrm{out}} = 218 - 0.72 = 217.28\,\mathrm{kJ}/\mathrm{kg}$.
...
\begin{itemize}
  ...
  = 1.276\,\mathrm{kJ}/\mathrm{kg}$. Process 4$\to$1 (condensation, no shaft work) satisfies the first law per unit mass: $q_{\mathrm{out}} = h_4 - h_1$; with $h_4 = h_3 - w_{\mathrm{out}} = 217.28\,\mathrm{kJ}/\mathrm{kg}$ from the expander step, $h_4 - h_1 = 217.28 - 216 = 1.28\,\mathrm{kJ}/\mathrm{kg} \approx 1.276$, consistent with the cycle balance.
\end{itemize}
